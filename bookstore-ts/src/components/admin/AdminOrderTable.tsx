...
interface AdminOrderTableProps {
    ...
    handleCreateOrder: (e: ReactSubmitEvent<Element>) => Promise<void>;
    handleDeleteOrder: (orderId: string) => void;
    handleSearchOrder: (e: ReactSubmitEvent<Element>) => Promise<void>;
};

function AdminOrderTable(props: AdminOrderTableProps)
{
    const {
        orders,
        isOrdersLoading,
